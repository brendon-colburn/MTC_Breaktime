...
Text(){
	"Timer will start when you press run.  It will be paused while you are on this config screen and start again from where you left off unless yo press reset timer."
} // End of Text
