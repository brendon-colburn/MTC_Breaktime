...
Default(){
	"We are on a short break.  Please take this time to stretch your legs and grab a snack.  We will be starting the session again in:"
} // End of Default
...
PressedBorderColor(){
	TxtBRBMessage.HoverBorderColor
} // End of PressedBorderColor

FocusedBorderColor(){
	TxtBRBMessage.BorderColor
