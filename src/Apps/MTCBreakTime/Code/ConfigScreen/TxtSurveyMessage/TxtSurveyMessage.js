...
Default(){
	"Please be sure to fill out our satisfaction survey:"
} // End of Default
...
PressedFill(){
	TxtSurveyMessage.Fill
} // End of PressedFill

PressedColor(){
	TxtSurveyMessage.Color
} // End of PressedColor

PressedBorderColor(){
	TxtSurveyMessage.HoverBorderColor
} // End of PressedBorderColor

FocusedBorderColor(){
	TxtSurveyMessage.BorderColor
